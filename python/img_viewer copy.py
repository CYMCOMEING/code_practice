...
class Window(QWidget):
    def __init__(self):
        ...
        self.listWidget.setLayout(container_layout)# 原来的
        # self.listWidget.setLayout(l)# 自己改

        self.qscrollarea = QtWidgets.QScrollArea(self)
        self.qscrollarea.setGeometry(QRect(0, 0, 600, 500))
        ...
        self.gl.addWidget(self.qscrollarea)
